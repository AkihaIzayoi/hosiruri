...
function optionsframework_options(){
    ...
    $options[] = array(
        ...
        'desc'=>__('上传你的支付宝收款二维码图片，图片尺寸要大于200px','moedog'),
        'id'=>'alipayqr_url',
    ...
    $options[] = array(
        ...
        'type'=>'upload');
    // $options[] = array(
    //     'name'=>__('顶部图片高度(px)','moedog'),
    //     'id'=>'background_image_height',
    //     'desc'=>__('顶部图片高度越大 越强调图片中心部分','moedog'),
    //     'std'=>'220',
    //     'type'=>'text');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'desc'=>__('请使用RGBA格式表示，推荐 195,98,195,.5(默认) || 22,23,26,.9(黑)','moedog'),
        'id'=>'banner_color',
        'std'=>'195,98,195,.5',
        'type'=>'text');
    $options[] = array(
        'name'=>__('移动端侧边栏菜单颜色','moedog'),
        'desc'=>__('请使用RGBA格式表示，推荐 195,98,195,.5(默认) || 42,42,42,.9(黑)','moedog'),
        'id'=>'mobi_color',
        'std'=>'195,98,195,.5',
        'type'=>'text');
    $options[] = array(
    ...
    $options[] = array(
        ...
        'type'=>'text');
    $options[] = array(
        'name'=>__('steam','moedog'),
        'desc'=>__('个人资料链接','moedog'),
        'id'=>'social_steam',
        'std'=>'',
        'type'=>'text');
    $options[] = array(
