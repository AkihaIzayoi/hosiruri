        ...
        <div class="row">
            ...
            if(kratos_option('show_head_cat')){ ?>
                <div class="kratos-hentry clearfix">
                    <h1 class="kratos-post-header-title"><?php _e('分类：','hoshiruri');echo single_cat_title('',false); ?></h1>
            ...
            if(kratos_option('show_head_tag')){ ?>
                <div class="kratos-hentry clearfix">
                    <h1 class="kratos-post-header-title"><?php _e('标签：','hoshiruri');echo single_cat_title('',false); ?></h1>
                    <h1 class="kratos-post-header-title"><?php echo category_description(); ?></h1>
                </div>
            <?php }
                }elseif(is_search()){ ?>
                <div class="kratos-hentry clearfix">
                    <h1 class="kratos-post-header-title"><?php _e('搜索结果：','hoshiruri');the_search_query(); ?></h1>
                </div>                
            <?php }
                if(have_posts()){
                    while(have_posts()){
            ...
            <div class="kratos-hentry clearfix">
                    <h1 class="kratos-post-header-title"><?php _e('很抱歉，没有找到任何内容。','hoshiruri'); ?></h1>
            </div>
            <?php }
