...
<div id="comments" class="comments-area">
    ...
    $args=array(
        ...
        'comment_field'=>'<div class="comment form-group has-feedback"><div class="input-group"><textarea class="form-control randow-background-'.mt_rand (1,3).'" id="comment" placeholder="'.__('|´・ω・)ノ还不快点说点什么呀poi~','moedog').'" name="comment" rows="5" aria-required="true" required  onkeydown="if(event.ctrlKey){if(event.keyCode==13){document.getElementById(\'submit\').click();return false}};"></textarea></div><div class="OwO"></div></div>',
    );
    comment_form($args); ?>
</div>