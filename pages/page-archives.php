                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        <div class="kratos-post-content">
                            <div id="archives">
                                <h2 class="title-h2" style="text-align:center;font-size:18pt"><?php _e('文章归档','hoshiruri'); ?></h2>
                                <p style="text-align:center"><span style="color:#999"><?php _e('当前共有','hoshiruri');echo wp_count_posts()->publish;_e('篇公开日志，','hoshiruri');echo wp_count_posts('page')->publish;_e('个公开页面。 (゜-゜)つロ 干杯~','hoshiruri'); ?></span></p>
                            <hr/>
                                <h4><?php _e('Tags','hoshiruri'); ?></h4>
                                <div class="arc-tag">
                                <?php echo $arc_tags; ?>
                                </div>
                            <hr/>
                                <h4><?php _e('Archives','hoshiruri'); ?></h4>
                        ...
                        <footer class="kratos-entry-footer clearfix">
                            <div class="post-like-donate text-center clearfix" id="post-like-donate"><?php
                                if(kratos_option('page_like_donate')) echo '<a href="javascript:;" class="Donate"><i class="fa fa-bitcoin"></i> '.__('打赏','hoshiruri').'</a>';
