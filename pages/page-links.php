                ...
                <article>
                    <div class="kratos-hentry kratos-post-inner clearfix">
                        <div class="kratos-post-content-l">
                            <h2 class="title-h2" style="text-align:center;font-size:18pt"><?php _e('自己的项目'); ?></h2>
                            <div class="linkpage">
                                <hr/>
                                <ul><?php
                            ...
                            <h2 class="title-h2" style="text-align:center;font-size:18pt"><?php _e('dalao们'); ?></h2>
                            <p style="text-align:center"><span style="color:#999999"><?php _e('dalao们的链接，每次刷新随机排序~'); ?></span></p>
                            <div class="linkpage">
                                <hr/>
                                <ul><?php
