...
<div class="kratos-post-inner">
    <header class="kratos-entry-header clearfix">
        ...
        <div class="kratos-post-meta">
            ...
            <a href="<?php the_permalink() ?>#comments"><i class="fa fa-commenting-o"></i> <?php comments_number('0','1','%');_e('条评论'); ?></a>
            </span>
            <span class="pull-left">
            <a href="<?php the_permalink() ?>"><i class="fa fa-eye"></i> <?php echo kratos_get_post_views();_e('次阅读'); ?></a>
            <a href="javascript:;" data-action="love" data-id="<?php the_ID(); ?>" class="Love<?php if(isset($_COOKIE['love_'.$post->ID])) echo ' done';?>"><i class="fa fa-thumbs-o-up"></i> <?php if(get_post_meta($post->ID,'love',true)) echo get_post_meta($post->ID,'love',true); else echo '0';_e('人点赞'); ?></a>
...
<div class="kratos-entry-border-new clearfix">
    ...
    <div class="kratos-post-meta-new">
        ...
        <span class="pull-right">
            <a class="read-more" href="<?php the_permalink() ?>" title="<?php _e('阅读全文'); ?>"><?php _e('阅读全文'); ?> <i class="fa fa-chevron-circle-right"></i></a>
        </span>
    </div>
</div>
<?php } ?>
