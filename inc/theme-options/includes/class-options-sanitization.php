...
function of_recognized_background_repeat() {
    $default = array(
        'no-repeat' => __( '不重复', 'hoshiruri' ),
        'repeat-x'  => __( '水平重复', 'hoshiruri' ),
        'repeat-y'  => __( '垂直重复', 'hoshiruri' ),
        'repeat'    => __( '全部重复', 'hoshiruri' ),
        );
    return apply_filters( 'of_recognized_background_repeat', $default );
}
function of_recognized_background_position() {
    $default = array(
        'top left'      => __( '上部左边', 'hoshiruri' ),
        'top center'    => __( '上部中间', 'hoshiruri' ),
        'top right'     => __( '上部右边', 'hoshiruri' ),
        'center left'   => __( '中部左边', 'hoshiruri' ),
        'center center' => __( '中部中间', 'hoshiruri' ),
        'center right'  => __( '中部右边', 'hoshiruri' ),
        'bottom left'   => __( '下部左边', 'hoshiruri' ),
        'bottom center' => __( '下部中间', 'hoshiruri' ),
        'bottom right'  => __( '下部右边', 'hoshiruri')
        );
    return apply_filters( 'of_recognized_background_position', $default );
}
function of_recognized_background_attachment() {
    $default = array(
        'scroll' => __( '正常滚动', 'hoshiruri' ),
        'fixed'  => __( '固定', 'hoshiruri')
        );
...
function of_recognized_font_styles() {
    $default = array(
        'normal'      => __( '常规', 'hoshiruri' ),
        'italic'      => __( '斜体', 'hoshiruri' ),
        'bold'        => __( '粗体', 'hoshiruri' ),
        'bold italic' => __( '斜粗体', 'hoshiruri' )
        );
